  ...
  return (
    <div className={cn(
      ...
      <blockquote className="text-gray-700 italic mb-6 relative">
        <span className="text-gold-dark text-xl font-playfair">"</span>
        {quote}
        <span className="text-gold-dark text-xl font-playfair">"</span>
      </blockquote>
      
      {/* Author Info */}
      <div className="flex items-center mt-6 border-t border-gold/10 pt-4">
        {avatarSrc && (
          <div className="mr-4 h-14 w-14 overflow-hidden rounded-full border-2 border-gold/30 shadow-soft transition-all duration-300 group-hover:border-gold/60">
            <img 
              src={avatarSrc} 
              alt={author} 
